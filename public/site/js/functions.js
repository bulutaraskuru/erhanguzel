...
(function ($) {
    ...
    var $window = $(window),
        ...
        $mainMenu = $("#mainMenu"),
        $mainMenuTriggerBtn = $(
            "#mainMenu-trigger a, #mainMenu-trigger button"
        ),
        //Slider
        $slider = $("#slider"),
            ...
            if ($customHeight.length > 0) {
                $customHeight.each(function () {
                    var elem = $(this),
                        ...
                        elemHeightLg =
                            elem.attr("data-height-lg") || elemHeight,
                        elemHeightMd =
                            elem.attr("data-height-md") || elemHeightLg,
                        elemHeightSm =
                            elem.attr("data-height-sm") || elemHeightMd,
                        elemHeightXs =
                            elem.attr("data-height-xs") || elemHeightSm;
    ...
    INSPIRO.header = {
        ...
        pageMenu: function () {
            ...
            if ($pageMenu.length > 0) {
                $(window).breakpoints("greaterEqualTo", "lg", function () {
                    var shrinkPageMenu =
                        $pageMenu.attr("data-shrink") ||
                        $pageMenu.offset().top + 200;
            ...
            if ($inspiroSlider.length > 0) {
                ...
                function animate_captions($elem) {
                    ...
                    $captions.each(function () {
                        ...
                        if ($(this).attr("data-animate-duration")) {
                            animationDuration =
                                $(this).attr("data-animate-duration") + "ms";
                        }
                        $captionElem.css({
                            opacity: 0,
                        });
                    ...
                    $captions.each(function (index) {
                        var $captionElem = $(this),
                            captionDelay =
                                ...
                                index * 350 + 1000,
                            captionAnimation =
                                $captionElem.attr("data-caption-animate") ||
                                defaultAnimation;
                ...
                function hide_captions($elem) {
                    ...
                    $captions.each(function (caption) {
                        var caption = $(this),
                            captionAnimation =
                                caption.attr("data-caption-animate") ||
                                defaultAnimation;
                ...
                function start_kenburn(elem) {
                    var currentSlide = elem.find(".slide.is-selected"),
                        currentSlideKenburns =
                            currentSlide.hasClass("kenburns");
                ...
                function sliderHeight(elem, state) {
                    var elem,
                        ...
                        screenRatio = elem.hasClass("slider-halfscreen")
                            ? 1
                            : 1.2,
                    ...
                    if (containerFullscreen >= windowHeight) {
                        ...
                        $sliderClassSlide.css(
                            "min-height",
                            sliderMinHeight + 100
                        );
                        elem.find(".flickity-viewport").css(
                            "min-height",
                            sliderMinHeight + 100
                        );
                    }
                ...
                $inspiroSlider.each(function () {
                    ...
                    elem.options = {
                        ...
                        prevNextButtons:
                            elem.data("arrows") == false ? false : true,
                        pageDots: elem.data("dots") == false ? false : true,
                        fade: elem.data("fade") == true ? true : false,
                        draggable: elem.data("drag") == true ? true : false,
                        freeScroll:
                            elem.data("free-scroll") == true ? true : false,
                        wrapAround: elem.data("loop") == false ? false : true,
                        groupCells:
                            elem.data("group-cells") == true ? true : false,
                        autoPlay: elem.attr("data-autoplay") || 7000,
                        pauseAutoPlayOnHover:
                            elem.data("hoverpause") == true ? true : false,
                        adaptiveHeight:
                            elem.data("adaptive-height") == false
                                ? false
                                : false,
                        asNavFor: elem.attr("data-navigation") || false,
                        selectedAttraction:
                            elem.attr("data-attraction") || 0.07,
                        friction: elem.attr("data-friction") || 0.9,
                        initialIndex: elem.attr("data-initial-index") || 0,
                        accessibility:
                            elem.data("accessibility") == true ? true : false,
                        setGallerySize:
                            elem.data("gallery-size") == false ? false : false,
                        resize: elem.data("resize") == false ? false : false,
                        cellAlign: elem.attr("data-align") || "left",
                        playWholeVideo:
                            elem.attr("data-play-whole-video") == false
                                ? false
                                : true,
                    };
                    ...
                    var inspiroSliderData = elem.flickity({
                        ...
                        selectedAttraction: Number(
                            elem.options.selectedAttraction
                        ),
                    ...
                    function wrapAroundStop() {
                        ...
                        var isAtLast =
                            flkty.selectedIndex == flkty.slides.length - 1;
                        if (isAtLast) {
                            disableAutoplay();
                        }
                    }
                    ...
                    inspiroSliderData.on("select.flickity", function () {
                        ...
                        animate_captions($captions);
                        var video =
                            flkty.selectedElement.querySelector("video");
                        if (video) {
                            video.play();
                            flkty.options.autoPlay = Number(
                                video.duration * 1000
                            );
                        } else {
                            flkty.options.autoPlay = Number(
                                elem.options.autoPlay
                            );
                        }
                ...
                $carousel.each(function () {
                    ...
                    elem.options = {
                        ...
                        accessibility:
                            elem.data("accessibility") == true ? true : false,
                        adaptiveHeight:
                            elem.data("adaptive-height") == true ? true : false,
                        autoWidth:
                            elem.data("auto-width") == true ? true : false,
                        setGallerySize:
                            elem.data("gallery-size") == false ? false : true,
                    ...
                    if (elem.hasClass("custom-height")) {
                        ...
                        INSPIRO.core.customHeight(
                            elem.find(".polo-carousel-item")
                        );
                        var carouselCustomHeightStatus = true;
                    }
                    if (Number(elem.options.items) !== 1) {
                        if (
                            elem.options.autoWidth ||
                            carouselCustomHeightStatus
                        ) {
                            ...
                            itemWidth =
                                (elem.options.containerWidth +
                                    Number(elem.options.margin)) /
                    ...
                    $carouselElem.imagesLoaded(function () {
                        ...
                        $carouselElem.flickity({
                            ...
                            autoPlay: Number(elem.options.autoPlay),
                            pauseAutoPlayOnHover:
                                elem.options.pauseAutoPlayOnHover,
                            adaptiveHeight: elem.options.adaptiveHeight,
                            asNavFor: elem.options.asNavFor,
                            initialIndex: elem.options.initialIndex,
                            accessibility: elem.options.accessibility,
    ...
    INSPIRO.elements = {
                ...
                $showHidePassword.each(function () {
                    ...
                    elemShowHideIcon.on("click", function (event) {
                        ...
                        if (elem.children("input").attr("type") == "text") {
                            ...
                            elem.children("input").attr("type") == "password"
                        ) {
                    ...
                    .animate(
                        {
                            scrollTop:
                                ...
                                (elem.options.headerHeight +
                                    elem.options.offsetTop),
                        },
                        elem.options.speed,
                        "easeInOutExpo"
                    );
                ...
                if ($body.hasClass("b--desktop")) {
                    if (elem.options.height) {
                        svg.setAttribute(
                            "style",
                            "height:" +
                                Number(elem.options.height).toFixed() +
                                "px"
                        );
                    } else {
                        svg.setAttribute(
                            "style",
                            "height:" +
                                Number(svg.height.baseVal.value).toFixed() +
                                "px"
                        );
                    }
                } else {
                    if (elem.options.height) {
                        svg.setAttribute(
                            "style",
                            "height:" +
                                Number(elem.options.height).toFixed() / 2 +
                                "px"
                        );
                    } else {
                        svg.setAttribute(
                            "style",
                            "height:" +
                                Number(svg.height.baseVal.value).toFixed() / 2 +
                                "px"
                        );
                    }
                }
            ...
            if ($map.length > 0) {
                ...
                $map.each(function () {
                    ...
                    elem.options = {
                        ...
                        fullscreen:
                            elem.data("fullscreen") == false ? false : true,
            ...
            if ($gridLayout.length > 0) {
                ...
                $gridLayout.each(function () {
                    ...
                    elem.options = {
                        ...
                        autoHeight:
                            elem.data("auto-height") == false ? false : true,
                        gridMargin: elem.attr("data-margin") || 20,
                        gridMarginXs: elem.attr("data-margin-xs"),
                        transitionDuration:
                            elem.attr("data-transition") || "0.45s",
                        isOriginLeft: isotopeRTL,
                    };

                    $(window).breakpoints("lessThan", "lg", function () {
                        elem.options.gridMargin =
                            elem.options.gridMarginXs ||
                            elem.options.gridMargin;
                    });
                    ...
                    ajax: {
                        ...
                        callbacks: {
                            ajaxContentAdded: function (mfpResponse) {
                                ...
                                if (
                                    $(".mfp-content").find(".carousel").length >
                                    0
                                ) {
                                    INSPIRO.slider.carousel(
                                        $(".mfp-content").find(".carousel")
                                    );
                                }
                            },
                        },
            ...
            if ($ytPlayer.length > 0) {
                ...
                $ytPlayer.each(function () {
                    ...
                    elem.options = {
                        ...
                        autoPlay:
                            elem.data("youtube-autoplay") == false ? 0 : 1,
                        mute: elem.data("youtube-mute") == false ? false : true,
                        pauseOnScroll:
                            elem.data("youtube-pauseOnScroll") == false
                                ? false
                                : true,
            ...
            if ($modal.length > 0) {
                $modal.each(function () {
                    var elem = $(this),
                        ...
                        elemCookieName =
                            elem.attr("data-cookie-name") ||
                            "cookieModalName2020_3",
                        elemCookieEnabled =
                ...
                $modalStrip.each(function () {
                    var elem = $(this),
                        ...
                        elemCookieExpire =
                            elem.attr("data-cookie-expire") || 365,
                        elemCookieName =
                            elem.attr("data-cookie-name") || "cookieName2013",
                        elemCookieEnabled =
                            elem.data("cookie-enabled") == true ? true : false,
                        elemModalDismissDelay = elem.attr("data-delay-dismiss");
                    /*Modal Auto Show*/
        ...
        notification: function (
            ...
            var $element,
                $elementContainer,
                $animateEnter =
                    "animate__" + $animateEnter || "animate__fadeInDown",
                $animateExit =
                    "animate__" + $animateExit || "animate__fadeOutDown",
                $placement,
                $backgroundImage,
                    ...
                    clipboardType.each(function () {
                        var elem = $(this),
                            title =
                                ...
                                "Copy to clipboard",
                            titleSuccess =
                                elem.attr("data-bs-original-title-success") ||
                                "Copied!";
                        elem.tooltip({
                            placement: "top",
                            title: title,
        ...
        videoBackground: function () {
            ...
            if ($videoBackground.length > 0) {
                $videoBackground.each(function () {
                    ...
                    setTimeout(function () {
                        $("#video-" + elem.options.randomId).addClass(
                            "video-loaded"
                        );
                    }, 300);
                });
                        ...
                        elem.find("#twitter-cnt").twittie(
                            ...
                            function () {
                                if (elem.parents(".grid-layout").length > 0) {
                                    elem.parents(".grid-layout").isotope(
                                        "layout"
                                    );
                                }
                            }
                    ...
                    $flickr_widget.jflickrfeed(
                        ...
                        function () {
                            ...
                            elem.magnificPopup(
                                ...
                                function () {
                                    if (
                                        elem.parents(".grid-layout").length > 0
                                    ) {
                                        elem.parents(".grid-layout").isotope(
                                            "layout"
                                        );
