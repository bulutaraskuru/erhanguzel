                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" required name="title_small"
                                                value="{{ old('title_small', $data->title_small) }}" id="title_small"
                                                maxlength="60" />
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" required name="title_big"
                                                value="{{ old('title_big', $data->title_big) }}" id="title_big"
                                                maxlength="60" />
                                        </div>

                                        {{-- <div class="mb-5">
                                            <label class=" required form-label">@lang('cms.description')</label>
                                            <textarea class="form-control" required name="description" id="description" maxlength="180">{{ old('description', $data->description) }}</textarea>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select fw-bold" data-kt-select2="true"
                                                data-prev-value="{{ old('link_type', $data->link_type) }}"
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select fw-bold" data-kt-select2="true"
                                                data-prev-value="{{ old('link', $data->link) }}"
                                                data-placeholder="@lang('cms.link')" data-allow-clear="true" name="link"
                                                id="link" data-hide-search="true">
                                            </select>
                                        </div>
