    ...
    <div id="kt_app_content" class="app-content flex-column-fluid py-2 py-lg-3">
        ...
        <div id="kt_app_content_container" class="app-container container-fluid">
            <div class="row g-5 g-xl-10 mb-5 mb-xl-10">
                <div class="card">
                    @include('admin.projectcategory.component.card-header')
                        ...
                        <table class="table table-hover table-striped align-middle table-row-dashedr gy-5" id="table">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold ">
                                    ...
                                    <th class="w-75px">@lang('cms.view_count')</th>
...
<script src="{{ asset('cms/assets/js/lightbox.js') }}"></script>
    <script>
        $(document).ready(function() {
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    type: 'GET',
                    url: route('admin.projectcategory.data'),
                    data: function(d) {
                        d.text = $('#text').val(),
                    ...
                    },
  {
            ...
            $(document).on('click', '.deleteButton', function() {
                ...
                var ID = $(this).attr('id');
                $.ajax({
                    url: route('admin.projectcategory.destroy', {
                        id: ID
                    }),
                    type: 'GET',
