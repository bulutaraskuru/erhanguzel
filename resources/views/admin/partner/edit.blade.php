                    ...
                    <div class="card">
                        <form action="{{ route('admin.' . $model . '.update', ['id' => $data->id]) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <label for="exampleFormControlInput1"
                                               class="required form-label">@lang('cms.img')
                                        </label>
                                        <img id="img-preview" src="{{ asset($data->img) }}" width="100%"/>
                                        <small style="color:blueviolet">(64x64 ölçülerinde olmalıdır)</small>
                                        <div>
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                                ...
                                                <option @selected(old('is_active',$data->is_active) == "1") value="1">
                                                    Aktif
                                                </option>
                                                <option @selected(old('is_active',$data->is_active) == "0") value="0">
                                                    Pasif
                                                </option>
                                            </select>
                                        </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea class="form-control" required name="description" id="description"
                                                      maxlength="180">{{ old('description', $data->description) }}</textarea>
                            ...
                            <div class="card-footer" style="padding:1rem 2.25rem !important;">
                                <button
                                    class="btn btn-warning text-dark">@lang('cms.' . $model) {{ TITLE_UPDATE }}</button>
                            </div>
                        </form>
                    </div>
                </div>
