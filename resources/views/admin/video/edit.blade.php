                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div>
                                            <input type="file" name="img" id="img"
                                                   class="form-control mb-5 mt-5 form-control" accept="image/*"
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1"
                                                class="required form-label">@lang('cms.file_url')</label>
                                            <input type="text" class="form-control mb-3"  name="video_url"
                                                value="{{ old('video_url',$data->video_url) }}" id="video_url" />
                                        </div>
                                    </div>
                                </div>
        ...
        $(document).ready(function () {
            ...
            tinymce.init({
                ...
                file_picker_callback: function (cb, value, meta) {
                    ...
                    input.setAttribute('type', 'video_url');
                    input.setAttribute('accept', 'image/*');
                    input.onchange = function () {
                        var video_url = this.files[0];

                        var reader = new FileReader();
                        reader.readAsDataURL(video_url);
                        reader.onload = function () {
                            var id = 'blobid' + (new Date()).getTime();
                            var blobCache = tinymce.activeEditor.editorUpload.blobCache;
                            var base64 = reader.result.split(',')[1];
                            var blobInfo = blobCache.create(id, video_url, base64);
                            blobCache.add(blobInfo);
                            cb(blobInfo.blobUri(), {
                                title: video_url.name
                            });
                        };
                    };
                    input.click();
