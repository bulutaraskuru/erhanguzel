                        ...
                        <form action="{{ route('admin.' . $model . '.store') }}" method="POST"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1"
                                                class="required form-label">{{ $model_text }} Tarihi</label>
                                            <input type="date" class="form-control" required name="created_at"
                                                value="{{ old('created_at') }}" id="created_at" maxlength="60" />
                                        </div>
                                    ...
                                    <div class="col-md-8">
                                        <div class="mb-5">
                                            <label class="form-label fs-6 fw-semibold">@lang('cms.projectcategory')</label>
                                            <select class="form-select  fw-bold" data-kt-select2="true"
                                                data-placeholder="@lang('cms.projectcategory')" data-allow-clear="true"
                                                name="project_category_id" id="project_category_id" data-hide-search="true">
                                                @foreach ($project_categories as $category)
                                                    <option @selected(old('project_category_id') == $category->id) value="{{ $category->id }}">{{ $category->title }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" required name="title"
                                                value="{{ old('title') }}" id="title" maxlength="60" />
                                        </div>
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" required name="seo_title"
                                                value="{{ old('seo_title') }}" id="seo_title" maxlength="60" />
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="text" class="form-control" required name="seo_keywords"
                                                value="{{ old('seo_keywords') }}" id="seo_keywords" />
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea class="form-control" required name="seo_description" id="seo_description" maxlength="180">{{ old('seo_description') }}</textarea>
