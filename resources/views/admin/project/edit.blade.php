                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <input type="date" class="form-control" required name="created_at"
                                                   value="{{ date('Y-m-d',strtotime($data->created_at)) }}" id="created_at" maxlength="60"/>
                                        </div>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="mb-5">
                                            ...
                                            <textarea class="form-control" required name="seo_description" id="seo_description"
                                                      maxlength="180">{{ old('seo_description', $data->seo_description) }}</textarea>
