    ...
    <script>
        $(document).ready(function() {
            ...
            var myDropzone = new Dropzone("#kt_dropzonejs_example_1", {
                ...
                url: route('admin.projectgallery.upload',"{{ $data->id }}"), // Set the url for your upload script location
            ...
            var table = $('#table').DataTable({
                ...
                ajax: {
                    type: 'GET',
                    url: route('admin.projectgallery.data', "{{ $data->id }}"),
                },
                columns: [
            ...
            $(document).on('click', '.deleteButton', function() {
                ...
                swalWithBootstrapButtons.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: route('admin.projectgallery.destroy', {
                                id: ID
                            }),
                            type: 'GET',
                            success: function(data) {
