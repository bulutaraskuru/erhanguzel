                    ...
                    <div class="card">
                        <form action="{{ route('admin.user.store') }}" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="text" name="name" id="name"
                                        class="form-control form-control-solid" placeholder="@lang('cms.name')" value="{{ old('name') }}" />
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <input type="email" name="email" id="email"
                                        class="form-control form-control-solid" placeholder="@lang('cms.email')" value="{{ old('email') }}" />
                                </div>
                                ...
                                <div class="mb-10">
                                    ...
                                    <select class="form-select form-select-solid" name="role" data-control="select2"
                                        ...
                                        @foreach ($roles as $role)
                                            <option @selected(old('role') == $role->id) value="{{ $role->id }}">
                            ...
                            <div class="card-footer" style="padding:1rem 2.25rem !important;">
                                <button class="btn  btn-light-primary">@lang('cms.user') {{ TITLE_CREATE }}</button>
                            </div>
                        </form>
                    </div>
                </div>
