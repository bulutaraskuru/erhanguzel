                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        ...
                                        <div>
                                            <input type="file" name="img" id="img"
                                                class="form-control mb-5 mt-5 form-control-file" onchange="readURL(this)" />
                                        </div>
                                        <div class="mb-10">
                                            <label class="form-label fs-6 fw-semibold">@lang('cms.is_active')</label>
                                            <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                                data-placeholder="@lang('cms.is_active')" data-allow-clear="true"
                                                name="is_active" id="is_active" data-hide-search="true">
                                    ...
                                    <div class="col-md-8">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="mb-10">
                                                    <label class="form-label fs-6 fw-semibold">@lang('cms.location')</label>
                                                    <select class="form-select fw-bold" data-kt-select2="true"
                                                        data-placeholder="@lang('cms.is_aclocationive')" data-allow-clear="true"
                                                        name="location" id="location" data-hide-search="true">
                                                        @foreach ($location_page as $key => $value)
                                                            <option @selected(old('location', $data->location) == $key)
                                                                value="{{ $key }}">
                                                                {{ $value }}</option>
                                                        @endforeach
                                                    </select>
                                        ...
                                        <div class="mb-5">
                                            <label for="exampleFormControlInput1"
                                                class="required form-label">@lang('cms.description')</label>
                                            <textarea class="description" name="description" id="description">{{ old('description', $data->description) }}</textarea>
                                        </div>
                                        <div class="mb-5">
                                            <label class=" required form-label">@lang('cms.seo_title')</label>
                                            <input type="text" class="form-control" required name="seo_title"
                                                value="{{ old('seo_title', $data->seo_title) }}" id="seo_title"
                                                maxlength="60" />
                                            <span class="fs-7 text-muted">Google uyumlu başlık maksimum girilcek
                                                karakter
                                                sayısı
                                                60'tır fazlası uygun değildir</span>
                                        </div>
                                        <div class="mb-5">
                                            <label class=" required form-label">@lang('cms.seo_keywords')</label>
                                            <input type="text" class="form-control" required name="seo_keywords"
                                                data-role="tagsinput"
                                                value="{{ old('seo_keywords', $data->seo_keywords) }}" id="seo_keywords" />
                                            <span class="fs-7 text-muted">Minimum 3 anahtar kelime en fazla 8 anahtar
                                                kelime olmalıdır .</span>
                                        </div>

                                        <div class="mb-5">
                                            <label class=" required form-label">@lang('cms.seo_description')</label>
                                            <textarea class="form-control" required name="seo_description" id="seo_description" maxlength="180">{{ old('seo_description', $data->seo_description) }}</textarea>
                                            <span class="fs-7 text-muted">Google uyumlu açıklama maksimum girilcek
                                                karakter
                                                sayısı
                                                180'dir fazlası uygun değildir</span>
                                        </div>
                                    </div>
                                </div>
