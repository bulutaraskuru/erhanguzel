    ...
    <div class="card-title">
        ...
        <div class="d-flex align-items-center position-relative my-1">
            ...
            <input type="text" id="text" class="form-control form-control-solid w-450px ps-14"
                placeholder="@lang('cms.title') yazınız ..." />
        </div>
        <!--end::Search-->
    </div>
    <!--begin::Card title-->
        ...
        <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
            ...
            <div class="menu menu-sub menu-sub-dropdown w-600px w-md-525px" data-kt-menu="true">
                ...
                <div class="px-7 py-5" data-kt-user-table-filter="form">
                    <form action="{{ route('admin.' . $model . '.export') }}" method="POST">
                        @csrf
                        <div class="mb-10">
                        ...
                        <div class="d-flex justify-content-end">
                            <button type="button" class="btn btn-danger fw-semibold me-2 px-6"
                                id="reset_filter_button">Temizle</button>
